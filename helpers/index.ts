...
export const locations = [
  ...
  { value: "asia", title: "⛩ Asia" },
  { value: "europe", title: "🇪🇺 Europe" },
  { value: "latin-america", title: "💃 Latin America" },
  { value: "middle-east", title: "🕌 Middle East" },
  { value: "north-america", title: "⛰️ North America" },
  ...
  { value: "caribbean-netherlands", title: "🇧🇶 Caribbean Netherlands" },
...
export const sortItems = [
  { value: "latest", title: "Latest jobs" },
  { value: "highest", title: "Highest Paid" },
  { value: "viewed", title: "Most viewed" },
  { value: "applied", title: "Most applied" },
  { value: "hottest", title: "Hottest" },
  { value: "benefits", title: "Most benefits" },
];
export const benefits = [
  { value: "401k", title: "401(k)" },
  { value: "distributed-team", title: "Distributed Team" },
  { value: "async", title: "Async" },
  { value: "vision-insurance", title: "Vision Insurance" },
  { value: "dental-insurance", title: "Dental Insurance" },
  { value: "medical-insurance", title: "Medical Insurance" },
  { value: "unlimited-vacation", title: "Unlimited vacation" },
  { value: "paid-time-off", title: "Paid time off" },
  { value: "4-day-workweek", title: "4 day workweek" },
  { value: "401k-matching", title: "401k matching" },
  { value: "company-retreats", title: "Company retreats" },
  { value: "coworking-budget", title: "Coworking budget" },
  { value: "learning-budget", title: "Learning budget" },
  { value: "free-gym-membership", title: "Free gym membership" },
  { value: "mental-wellness-budget", title: "Mental wellness budget" },
  { value: "home-office-budget", title: "Home office budget" },
  { value: "pay-in-crypto", title: "Pay in crypto" },
  { value: "pseudonymous", title: "Pseudonymous" },
  { value: "profit-sharing", title: "Profit sharing" },
  { value: "equity-compensation", title: "Equity compensation" },
  { value: "no-whiteboard-interview", title: "No whiteboard interview" },
  { value: "no-monitoring-system", title: "No monitoring system" },
  { value: "no-politics-at-work", title: "No politics at work" },
  { value: "we-hire-old-young", title: "We hire old (young)" },
];
...
export function capitalize(str: String, lc = true, all = true) {
  if (str.includes(".")) {
...
export function capitalizeSpecialCharacters(str: string, sc: string) {
  return str
    .split(sc)
